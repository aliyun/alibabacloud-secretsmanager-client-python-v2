Aliyun Secrets Manager Client for Python V2
===========================================

The Aliyun Secrets Manager Client for Python V2 enables Python
developers to easily work with Aliyun KMS Secrets.
...
.. code:: python
   ...
   from alibaba_cloud_secretsmanager_client.secret_manager_cache_client_builder import SecretManagerCacheClientBuilder
   from alibaba_cloud_secretsmanager_client.service.default_secret_manager_client_builder import DefaultSecretManagerClientBuilder
   from alibaba_cloud_secretsmanager_client.utils.credentials_provider_utils import CredentialsProviderUtils
